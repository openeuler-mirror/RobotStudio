...
const expectContentSize = { width: 920, height: 480 }

async function createWindow() {
  win = new BrowserWindow({
    title: 'Main window',
    icon: join(process.env.PUBLIC, 'favicon.ico'),
    width: expectContentSize.width,
    height: expectContentSize.height,
    resizable: false,
  ...
  // 为了方便调试，显示了titlebar，需要考虑titbar的高度，增加内容的高度
  win.setSize(
    expectContentSize.width + win.getSize()[0] - win.getContentSize()[0],
    expectContentSize.height + win.getSize()[1] - win.getContentSize()[1]
  )
  // console.log('size', win.getContentBounds())
